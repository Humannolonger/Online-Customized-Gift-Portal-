  ...
  return (
    <div className="gift-container">
      <div className="input-field">
        ...
        <button className='button' onClick={!bolin ? addinputdata : updateinfo}>{!bolin ? 'Add data' : 'Update data'}</button>
      </div>
          ...
          <tbody>
            ...
            {array && array.map((item, i) => (
              <tr   className='gift-tr' key={i}>
                ...
                <td className="action-buttons"><button  onClick={() => updatedata(i)}>Update</button></td>
                <td className="action-buttons"><button onClick={() => deletedata(i)}>Delete</button></td>
              </tr>
            ))}
          </tbody>
        </table>
