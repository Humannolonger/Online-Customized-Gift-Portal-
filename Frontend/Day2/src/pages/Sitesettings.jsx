...
Whether youre celebrating a special occasion or simply expressing your love we invite you to join us in the art of gift customization. Explore our collection, unleash your creativity, and let us help you create moments that last a lifetime. Thank you for choosing Presents. We look forward to being part of your cherished memories.'
/><br/>
        ...
        <div className='sitesetting-contactus'><h2>Contact Us</h2>
            ...
            At Presents, we value communication and are here to assist you in any way possible. Whether you have questions about our products, need assistance with customization, or want to explore partnership opportunities, were just a message away.
            Customer Support
            ...
            Email: partnerships@presents.com'/>
        </div>
        <button className='sitesetting-btn1'>Edit</button> 
        <button className='sitesetting-btn2'>Save Changes</button> 
        </div>
